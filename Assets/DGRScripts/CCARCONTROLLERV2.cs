...
namespace GoogleARCore.HelloAR
{
    ...
    /// </summary>
    public class CCARCONTROLLERV2 : MonoBehaviour
    {
        ...
        bool startthegame;
        public GameObject landedsafelytext;
        ...
        public void Update()
        {
            ...
            GameObject lander = GameObject.FindGameObjectWithTag("Player");
            audiosource = lander.GetComponent<AudioSource>();
        ...
        public void gogogo()
        {
            ...
            TrackedPlanePrefab.SetActive(false);
            removeobjectbuttons();
        ...
        {
            firingengines = false;
            thrusttext.color = new Color(0, 0, 255, 255);
            audiosource.Stop();
        ...
        public void hideallUI()
        {
            ...
            distanceslider.SetActive(false);
            stats.SetActive(false);
            landedsafelytext.SetActive(true);
            restartbutton.SetActive(true);
        }

        public void restartonelanded()
        {
